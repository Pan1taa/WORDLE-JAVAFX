...
public class Main {
    ...
    //------------------------------------ 5
            for (int i = 0; i < guess.length(); i++) {
                ...
                if (letter.equals(word.substring(i, i + 1))) {
                    row[i].setStyle("-fx-background-color: #5dc74e;"); //verde
                } else if (word.contains(letter)) {
                    row[i].setStyle("-fx-background-color: #2454c9;"); //azul
                } else {
                    row[i].setStyle("-fx-background-color: #b93737;"); //rojo
                }
            }
    ...
    private void resetBox() {
        ...
        for (Label label : row) {
            label.setText("");
            label.setStyle("-fx-background-color: #ffffff;"); //blanco
        }
    }
    //------------------------------ 7
